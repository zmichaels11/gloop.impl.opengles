...
public final class GLES3XDriver implements Driver<
    ...
    @Override
    public void framebufferAddDepthAttachment(GLES3XFramebuffer framebuffer, GLES3XTexture texId, int mipmapLevel) {
        final int currentFb = GLES20.glGetInteger(GLES20.GL_FRAMEBUFFER_BINDING);

        switch (texId.target) {
            case GLES20.GL_TEXTURE_2D:
                GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, framebuffer.framebufferId);
                GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_DEPTH_ATTACHMENT, GLES20.GL_TEXTURE_2D, texId.textureId,  mipmapLevel);
                GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, currentFb);
                break;
            default:
                throw new UnsupportedOperationException("Unsupported texture target!");
    ...
    @Override
    public void framebufferAddDepthStencilAttachment(GLES3XFramebuffer framebuffer, GLES3XTexture texId, int mipmapLevel) {
        final int currentFb = GLES20.glGetInteger(GLES20.GL_FRAMEBUFFER_BINDING);

        switch (texId.target) {
            case GLES20.GL_TEXTURE_2D:
                GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, framebuffer.framebufferId);
                GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES30.GL_DEPTH_STENCIL_ATTACHMENT, GLES20.GL_TEXTURE_2D, texId.textureId,  mipmapLevel);
                GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, currentFb);
                break;
            default:
                throw new UnsupportedOperationException("Unsupported texture target!");
